...
<div class="bp-intro">
    <div class="tldr-box">
      ...
      <ul>
        ...
        <li><strong>Fast Setup:</strong> If you want to skip the theory, check out the [MeshWG Quickstart](/quickstart/) or create your free account and jump to Step 1. Otherwise, read on to understand why the setup works and how to avoid the mistakes that break most DIY WireGuard meshes.</li>
      </ul>
    </div>
</div>
